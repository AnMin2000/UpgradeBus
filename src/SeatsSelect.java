...
//    static JLabel[] img2 = new JLabel[29];    // 좌석 정보를 담을 1차원 배열
    ...
    public SeatsCenter(SeatsSelect frame, String id, String start, String end, String date) {
        setLayout(null);
        this.id = id;   // 회원 아이디 정보 저장
        //this.price = Integer.valueOf(info[0]);
        ...
        // 결제진행 버튼 이미지
        ImageIcon paymentIcon = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/payment.png");
        ...
        ImageIcon paymentIcon2 = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/payment2.png");
        ...
        payment.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (col == 10000) {
                    ...
                    new Payment(frame, id, start, end, date, price, seatNum[row][col]);
                    frame.setVisible(false);
                }
            }
        });
    ...
    public void create_seats(JPanel p) {
        // 선택 가능 이미지
        ImageIcon possible = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/white_seats.png");
        ...
        // 선택 불가능 이미지
        ImageIcon impossible = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/black_seats.png");
    ...
    public void init_seats(JPanel p) {
        ...
        ImageIcon white = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/white_seats.png");
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (s.getIcon().equals(updateWhiteIcon)) {
            // 검은색 좌석 이미지로 교체
            ImageIcon black = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/black_seats.png");
...
public class SeatsSelect extends JFrame {
    public SeatsSelect(ReservationMain frame, String id, String start, String end, String date) {
        setTitle("버스타슈~");
        setSize(1000,800);
        setResizable(false);
        ...
        mainContainer.add(new SeatsCenter(this, id, start, end, date), BorderLayout.CENTER);
