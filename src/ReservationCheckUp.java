...
public class ReservationCheckUp extends JFrame implements MouseListener {
    ...
    public ReservationCheckUp(String id) {
        ...
        String[] data1 = {"2023-08-01","청주","서울","09:00","우진관광","일반","18,000원","1,2번"};
        model.addRow(data1);
        ...
        ImageIcon reservecancel1 = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/reservecancel1.png");
        ...
        ImageIcon reservecancel2 = new ImageIcon("C:/Users/user/IdeaProjects/Hello-World--main/Hello-World--main/project__java/buspj/image/reservecancel2.png");
